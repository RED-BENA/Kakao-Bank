$(document).ready(function() {
  ...
  $('.js-more-button').click(function(e) { // 더보기 버튼을 눌렀을 때
    ...
    $('.js-question-detail__list__item:nth-of-type(-n+'+question_count+')').addClass('active');
  ...
  $('.js-question-detail__list__item').click(function(e) {
    if ($(this).find('.js-item-detail').hasClass('active')) {
      ...
      $(this).next('.js-question-detail__list__answer').slideUp(250);
    } else {
      $(this).find('.js-item-detail').addClass('active');
      $(this).next('.js-question-detail__list__answer').slideDown(250);
    }
  });
});
